Pod::Spec.new do |s|
s.name         = "ComponentMiddleware" # 组件化中间件
...
s.source_files = "ComponentMiddleware/*.{h,m}" # 你代码的位置， ComponentMiddleware/*.{h,m} 表示 BLSettingCell 文件夹下所有的.h和.m文件
s.public_header_files = 'ComponentMiddleware/*.{h}'
#s.resource_bundles = {
#'ComponentMiddleware' => ['ComponentMiddleware/ComponentMiddleware.bundle/*.png']
#}
